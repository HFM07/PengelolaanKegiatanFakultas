...
Route::post('Tambah/{Id}/updateKegiatanApproval', [\App\Http\Controllers\kegiatanApprovalController::class, 'updateKegiatanApproval'])->name('kegiatanApproval.updateKegiatanApproval');
