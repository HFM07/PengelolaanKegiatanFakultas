...
Route::group(['middleware' => ['auth', 'checkHakAkses:Lv1,Lv2']], function () {
...
// Route khusus Admin
Route::group(['middleware' => ['auth', 'checkHakAkses:Lv1']], function () {
    ...
    Route::get('/user/{id}/getEditUser', [\App\Http\Controllers\userController::class, 'getEditUser'])->name('user.EditUser');
    Route::delete('/user/{id}/hapusUser', [\App\Http\Controllers\userController::class, 'hapusUser'])->name('user.hapusUser');

    Route::get('/kegiatan/{Id}/getEditKegiatan', [\App\Http\Controllers\kegiatanController::class, 'getEditKegiatan'])->name('kegiatan.EditKegiatan');
