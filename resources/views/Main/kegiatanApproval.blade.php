...
<body>
    ...
    <div class="container">
        ...
        @endif
        <h5>Daftar Kegiatan Approval</h5>
            ...
            <tbody>
                @foreach ($kegiatanApproval as $item => $i)
                    <tr>
                        ...
                        <td>{{ $i->Status }}</td>
                        <td>
                            <a href="/kegiatanApproval/{{ $i->Id }}/getEditKegiatanApproval" class="ButtonS"><i
            ...
            $('.ButtonH').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: "/kegiatanApproval/" + $(this).data('id') +
                                "/hapusKegiatanApproval",
                            data: {
                                _token: "{{ csrf_token() }}"
                            },
